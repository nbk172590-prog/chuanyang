        ...
        <main className="bg-white min-h-screen">
                ...
                <div className="mx-auto max-w-6xl grid gap-12 lg:grid-cols-[1.2fr_0.8fr] items-start">
                    <div className="space-y-6">
                        ...
                        <p className="max-w-2xl text-base text-slate-600 sm:text-lg">
                            A premium kitchen faucet with precision engineering, elegant matte finish, and smart water
                            flow control. Designed for modern interiors and built for long-lasting performance.
                        </p>
                        ...
                        <div className="grid gap-4 sm:grid-cols-2">
                            ...
                            <div className="rounded-[32px] border border-slate-200 bg-white p-8 shadow-sm">
                                ...
                                <p className="mt-5 text-sm text-slate-600">
                                    Crafted with premium materials and engineered for quiet operation, the CY Signature
                                    faucet blends luxury design with everyday convenience.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <section className="bg-[#F6F7F8] py-14 px-4 sm:px-6 lg:px-10">
                <div className="mx-auto max-w-6xl">
                    ...
                    <p className="mt-3 max-w-2xl text-base text-slate-600">Browse more items that complement this
                        premium kitchen collection.</p>
